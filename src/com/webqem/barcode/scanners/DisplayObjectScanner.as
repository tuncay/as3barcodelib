...
package com.webqem.barcode.scanners {
	...
	public class DisplayObjectScanner extends EventDispatcher {
		...
		public function DisplayObjectScanner(input:DisplayObject = null, output:BitmapData = null, scaleMtrx:Matrix = null, delay:uint = 500) {
			...
			scanTimer = new Timer(this.delay);
